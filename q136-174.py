...
VALUES 
(2, 3, 'Звуковой сигнал "Прошу уменьшить ход"', 'six_options', 'продолжительный и короткий звук',
...
option1, option2, option3, option4, option5, option6)
VALUES 
(2, 3, 'Звуковой сигнал "Прошу выйти на связь"', 'six_options', 'продолжительный, короткий и продолжительный звук',
'один продолжительный звук', 'один короткий звук', 'серия коротких звуков', 
...
option1, option2, option3, option4, option5, option6)
VALUES 
(2, 1, 'Минимальный запас по высоте при прохождении судов под мостами, при высоте моста над рабочим (фактическим) уровнем воды 16,1 и более м, на зарегулированных участках составляет', 'six_options', '0,5 м',
'0,2 м', '0,3 м', '0,4 м', '0,5 м', '1 м', '0,1 м')
''')
...
option1, option2, option3)
VALUES 
(2, 2, 'Работа членов экипажа судна в замкнутых помещениях', 'three_options', 'без наблюдающего запрещается',
...
option1, option2, option3)
VALUES 
(2, 2, 'В цистернах и танках из-под нефтепродуктов для освещения должны применяться', 'three_options', 'переносные аккумуляторные фонари взрывобезопасного исполнения с напряжением 12 В',
